...
export const getToonSortedPowerEntries = state => {
  if (!state.toon) { return null }
  let toon = state.toon
  const power_entries = state.toon.builds[state.toon.current_build].power_entries
  const level = state.toon.level
  let sortedPowerEntries = []
  sortedPowerEntries.push({ level: 'level_1_primary', power_entry: power_entries.level_1_primary })
  sortedPowerEntries.push({ level: 'level_1_secondary', power_entry: power_entries.level_1_secondary })
  sortedPowerEntries.push({ level: 'level_2', power_entry: power_entries.level_2 })
  sortedPowerEntries.push({ level: 'level_4', power_entry: power_entries.level_4 })
  sortedPowerEntries.push({ level: 'level_6', power_entry: power_entries.level_6 })
  sortedPowerEntries.push({ level: 'level_8', power_entry: power_entries.level_8 })
  sortedPowerEntries.push({ level: 'level_10', power_entry: power_entries.level_10 })
  sortedPowerEntries.push({ level: 'level_12', power_entry: power_entries.level_12 })
  sortedPowerEntries.push({ level: 'level_14', power_entry: power_entries.level_14 })
  sortedPowerEntries.push({ level: 'level_16', power_entry: power_entries.level_16 })
  sortedPowerEntries.push({ level: 'level_18', power_entry: power_entries.level_18 })
  sortedPowerEntries.push({ level: 'level_20', power_entry: power_entries.level_20 })
  sortedPowerEntries.push({ level: 'level_22', power_entry: power_entries.level_22 })
  sortedPowerEntries.push({ level: 'level_24', power_entry: power_entries.level_24 })
  sortedPowerEntries.push({ level: 'level_26', power_entry: power_entries.level_26 })
  sortedPowerEntries.push({ level: 'level_28', power_entry: power_entries.level_28 })
  sortedPowerEntries.push({ level: 'level_30', power_entry: power_entries.level_30 })
  sortedPowerEntries.push({ level: 'level_32', power_entry: power_entries.level_32 })
  sortedPowerEntries.push({ level: 'level_35', power_entry: power_entries.level_35 })
  sortedPowerEntries.push({ level: 'level_38', power_entry: power_entries.level_38 })
  sortedPowerEntries.push({ level: 'level_41', power_entry: power_entries.level_41 })
  sortedPowerEntries.push({ level: 'level_44', power_entry: power_entries.level_44 })
  sortedPowerEntries.push({ level: 'level_47', power_entry: power_entries.level_47 })
  sortedPowerEntries.push({ level: 'level_49', power_entry: power_entries.level_49 })
  sortedPowerEntries.push({ level: 'health', power_entry: power_entries.health })
  sortedPowerEntries.push({ level: 'stamina', power_entry: power_entries.stamina })
  sortedPowerEntries.push({ level: 'brawl', power_entry: power_entries.brawl })
  sortedPowerEntries.push({ level: 'prestige_power_slide', power_entry: power_entries.prestige_power_slide })
  if (2 <= level) sortedPowerEntries.push({ level: 'sprint', power_entry: power_entries.sprint })
  if (2 <= level) sortedPowerEntries.push({ level: 'hurdle', power_entry: power_entries.hurdle })
  if (2 <= level) sortedPowerEntries.push({ level: 'swift', power_entry: power_entries.swift })
  if ('Class_Peacebringer' === state.toon.archetype_id || 'Class_Warshade' === state.toon.archetype_id) {
    for (let buildIndex = 0; buildIndex < toon.builds.length; buildIndex++) {
      sortedPowerEntries.push({ level: 'level_1_kheldian', power_entry: power_entries.level_1_kheldian })
      if (10 <= level) sortedPowerEntries.push({ level: 'level_10_kheldian', power_entry: power_entries.level_10_kheldian })
      if (null !== power_entries.nova_1) sortedPowerEntries.push({ level: 'nova_1', power_entry: power_entries.nova_1 })
      if (null !== power_entries.nova_2) sortedPowerEntries.push({ level: 'nova_2', power_entry: power_entries.nova_2 })
      if (null !== power_entries.nova_3) sortedPowerEntries.push({ level: 'nova_3', power_entry: power_entries.nova_3 })
      if (null !== power_entries.nova_4) sortedPowerEntries.push({ level: 'nova_4', power_entry: power_entries.nova_4 })
      if (null !== power_entries.dwarf_1) sortedPowerEntries.push({ level: 'dwarf_1', power_entry: power_entries.dwarf_1 })
      if (null !== power_entries.dwarf_2) sortedPowerEntries.push({ level: 'dwarf_2', power_entry: power_entries.dwarf_2 })
      if (null !== power_entries.dwarf_3) sortedPowerEntries.push({ level: 'dwarf_3', power_entry: power_entries.dwarf_3 })
      if (null !== power_entries.dwarf_4) sortedPowerEntries.push({ level: 'dwarf_4', power_entry: power_entries.dwarf_4 })
      if (null !== power_entries.dwarf_5) sortedPowerEntries.push({ level: 'dwarf_5', power_entry: power_entries.dwarf_5 })
      if (null !== power_entries.dwarf_6) sortedPowerEntries.push({ level: 'dwarf_6', power_entry: power_entries.dwarf_6 })
    }
  }
